...
export NWCHEM_TOP=${HOME}/NWCHEM/arm
export NWCHEM_TARGET=LINUX64
export NWCHEM_MODULES="all"

#MPI_PATH=/opt/amazon/openmpi
MPI_PATH=${HOME}/MPI/arm-ompi-4.1.1
...
export BLASOPT="-DOPENBLAS /software/ACFL/21.0/armpl-21.0.0_AArch64_RHEL-7_arm-linux-compiler_aarch64-linux/lib/libarmpl_ilp64.a"
